...
export default function MainLayout({ children }) {
  const services = [
    {
      id: 1,
      src: "/images/services-image/Group 16.png",
      alt: "best price",
    ...
    {
      id: 2,
      src: "/images/services-image/Group 17.png",
      alt: "support",
      title: "پشتیبانی",
    ...
    {
      id: 3,
      src: "/images/services-image/Group 18.png",
          ...
          {services.map((item) => (
            ...
            >
              ...
              <div>
                ...
                <p className="font-VazirDigitThin text-xs font-light leading-[18px] tracking-wide lg:text-[16px] lg:leading-[25px]">
                  {item.description}
                </p>
              </div>
            </div>
